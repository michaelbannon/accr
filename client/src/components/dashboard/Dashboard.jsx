      ...
      <aside>
        <div className="dashboard-nav-container">
          ...
          <nav className="dashboard-main-nav">
            <ul>
              <li>
                <Link className="dashboard-main-nav__link" to="/dashboard/home">
              ...
              <li>
                <Link className="dashboard-main-nav__link dashboard-main-nav__link--selected" to="/dashboard/bet">
              ...
              <li>
                <Link className="dashboard-main-nav__link" to="/dashboard/leaderboards">
